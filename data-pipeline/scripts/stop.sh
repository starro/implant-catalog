#!/usr/bin/env bash
# 파이프라인 서버 종료 (좀비 세션까지 정리).
#   bash scripts/stop.sh              # FiftyOne
#   bash scripts/stop.sh fiftyone     # (=5151) FiftyOne (세션 트리 전체: 서버·워커·mongod)
